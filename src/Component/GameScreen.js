        ...
        <Wrapper>
            ...
            <Row>
                <RowItems>
                    <RowBox>
                        {
                            picker===0 ? <Image src= {zero}/>: 
                            picker===1 ? <Image src= {one}/>: 
                            picker===2 ? <Image src= {two}/>: 
                            picker===3 ? <Image src= {three}/>: 
                            picker===4 ? <Image src= {four}/>: 
                            picker===5 ? <Image src= {five}/>: null
                        }
                    </RowBox>
                    <Number>
                         <DisplayBox 
            ...
            <Result>
                ...
                <DisplayResult>
                            {
                            picker===computer ? <Image src={victory}/> : <span>You lost</span>
                            }
                </DisplayResult>
            </Result>
        </Wrapper>
